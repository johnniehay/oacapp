...
/**
 * Formats an array of populatedAuthors from Updates into a prettified string.
 * @param authors - The populatedAuthors array from a Update.
...
export const formatAuthors = (
  authors: NonNullable<NonNullable<Update['populatedAuthors']>[number]>[],
) => {
