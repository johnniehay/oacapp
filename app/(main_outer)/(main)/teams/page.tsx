...
export default async function Teams(){
  ...
  const teamdata = payloadteams.map(team => [/*team.number,*/team.name,(<div key={team.number}><Flag country={team.country} /> {team.country}</div>), team.shared_contact ?? ""])//, <Link key={team.number} href={`/schedule/team/${team.number}`}>Schedule</Link> ])
