...
export async function GET(request: NextRequest){
  ...
  const txtdbg = false
  const PersonPDF = ({person, position}: {person:Person, position:number} ) => (
    (!!person.team && typeof person.team !== "string") &&
    <View style={{position:"absolute", ...positionOffsets[position]}} wrap={false} >
      ...
      <Text debug={txtdbg} style={{...commmonTextStyles,top:"4.6cm"/*4.1*/,left: "0.5cm",minHeight:undefined,fontSize:"0.6rem"}} hyphenationCallback={w => [w]}>Team</Text>
